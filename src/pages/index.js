        ...
        <div class="flex-shrink-0">
          <div className="flex justify-center items-center h-10 w-10 rounded-md bg-light-blue-vivid-700">
            ...
            >
              ...
              />
              <path
                class="primary text-light-blue-vivid-100"
        ...
        <div className="flex-shrink-0">
          <div className="flex justify-center items-center h-10 w-10 rounded-md bg-light-blue-vivid-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              class="icon-book-open h-8 w-8 fill-current"
            >
              <g>
                <path
                  class="secondary text-light-blue-vivid-050"
        ...
        <div className="flex-shrink-0">
          <div className="flex justify-center items-center h-10 w-10 rounded-md bg-light-blue-vivid-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              class="icon-buoy fill-current h-8 w-8 "
            >
              <g>
                <path
                  class="secondary text-light-blue-vivid-050"
